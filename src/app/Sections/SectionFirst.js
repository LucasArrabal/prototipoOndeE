        ...
        <div className="flex  p-20 justify-center items-center h-full ">
          <div className="w-full text-left flex flex-col gap-8">
            ...
            <div className="text-center flex flex-col gap-3 items-center">
             ...
             <button type="button" onClick={() => router.push('/')} className="box-border relative z-30 inline-flex items-center justify-center w-2/3 lg:w-44 lg:px-9 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-orange-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-orange-300 ring-offset-orange-200 hover:ring-offset-orange-500 ease focus:outline-none">
